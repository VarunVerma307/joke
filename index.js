let jokesArray = [
    ...
    "How can you tell it is a dogwood tree? By the bark.",
    ...
    "Why don't we see elephants hiding in trees? Because they are really good at it.",
  ...
  var div1=document.getElementsByClassName("joke")[0];
  newjoke=()=>{
    let index= jokesArray[Math.floor((Math.random())*jokesArray.length)];
    console.log(index)
    div1.innerHTML=index;
  }
  let btn=document.getElementById("jokke");
